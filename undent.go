...
//
// This Undent implementation is a re-write of Jim Myhrberg's
// https://github.com/jimeh/Undent. I decided to re-write it because I was
// unable to understand the original implementation, and thus could not fix it.
//
